...
const EXPECTED = {
  ...
  sync: ['initFirebaseSync', 'fetchCloudState', 'pullFromCloud', 'manualSync',
         'mergeCloudPerField', 'isEmptyForField', 'rehydrateCompletedVideos',
         'pruneHistoryMaps', 'PLAN_CLOUD_KEYS', 'MAX_CLOCK_SKEW_MS'],
