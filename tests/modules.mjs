...
const EXPECTED = {
  ...
  sourceData: ['SOURCE_DATA', 'qualifySourceData', 'initSourceData', 'getDataset',
               ...
               'getVideoCompletedDate', 'getLatestCompletedAt',
               'getChapterCompletedDate', 'getSubjectCompletedDate'],
  ...
  charts: ['renderExecutionChart', 'renderPixelSubjectHeatmap', 'renderMonth30Detail'],
