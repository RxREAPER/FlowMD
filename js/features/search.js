  ...
  function renderSpotlightResults(query) {
    ...
    if (!q) {
      ...
      container.innerHTML = `
        ...
        <div style="font-family: 'Inter', system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif; font-size: 0.88rem; color: var(--text-muted); padding: 8px 0 4px 4px; line-height: 1.8;">
    ...
    container.innerHTML = `
      ...
      ${searchData.subjects.length > 0 ? `
        <div class="fm-command-group-header"><svg class="material-symbols-outlined" style="font-size:18px;"><use href="#fmd-i-menu_book"/></svg> Subjects (${searchData.subjects.length})</div>
      ...
      ${searchData.chapters.length > 0 ? `
        <div class="fm-command-group-header"><svg class="material-symbols-outlined" style="font-size:18px;"><use href="#fmd-i-auto_stories"/></svg> Chapters (${searchData.chapters.length})</div>
      ...
      ${searchData.videos.length > 0 ? `
        <div class="fm-command-group-header"><svg class="material-symbols-outlined" style="font-size:18px;"><use href="#fmd-i-play_circle"/></svg> Video Topics (${searchData.videos.length})</div>
