/* ============================================================
   ...
   Dual-Track toggle (issue #10). The Daily Tasks topics section
   that used to trail this sheet was removed in issue #11 — topic
   mode (Auto/Manual) is managed from the dashboard's Daily Tasks
   card only.
   ============================================================ */
(function () {
  'use strict';
  ...
  const { STUDY_SOURCES, DEFAULT_PLAN, PLAN_A_ACCENT, PLAN_B_ACCENT, toLocalDateKey, escapeHtml, escapeAttr } = window.FlowMD.constants;
